...
class Cms extends App_Controller
{
    ...
    function getDashboardStat_get()
    {
        ...
        if ($this->getUserRoleId() == 1) {
            ...
            array_push($dashboard_stat, array('cmsNodeKeyName' => 'timesheetLog', 'targetRole' => '1', 'heading' => 'employees logged tasks *', 'infoText' => '', 'textCSS' => '', 'bg_css' => '', 'digitCSS' => '', 'icon' => 'calendar',  'iconCss' => 'text-cyan-500', 'count' => $stat_timesheet_user['data_rows'][0]['total'], 'otherCount' => $stat_timesheet_user['data_rows'][0]['total'], 'url' => 'timesheet/report'));

            array_push($dashboard_stat, array('cmsNodeKeyName' => 'leaveApproved', 'targetRole' => '1', 'heading' => 'leave apps. approved *', 'infoText' => '', 'textCSS' => '', 'bg_css' => '', 'digitCSS' => '', 'icon' => 'check', 'iconCss' => 'text-purple-500', 'count' => $stat_user_applied_leave['data_rows'][0]['total'], 'otherCount' => $stat_user_approved_leave['data_rows'][0]['total'], 'url' => 'leave/manage'));
        }

        array_push($dashboard_stat, array('cmsNodeKeyName' => 'leaveToApprove', 'targetRole' => '3', 'heading' => 'leave apps. waiting for your review', 'infoText' => '', 'textCSS' => '', 'bg_css' => '', 'digitCSS' => '', 'icon' => 'pendingaction', 'iconCss' => 'text-indigo-500', 'count' => $stat_pending_leave_action['data_rows'][0]['total'], 'otherCount' => $stat_pending_leave_action['data_rows'][0]['total'], 'url' => 'leave/requests-to-approve'));

        array_push($dashboard_stat, array('cmsNodeKeyName' => 'taskLog', 'targetRole' => '3', 'heading' => 'days task you have logged *', 'infoText' => '', 'textCSS' => '', 'bg_css' => '', 'digitCSS' => '', 'icon' => 'clock', 'iconCss' => 'text-red-500', 'count' => $stat_user_timesheet_stat['stat_data']['total_days'], 'otherCount' => $stat_user_timesheet_stat['stat_data']['total_days'], 'url' => 'timesheet/log-work'));
